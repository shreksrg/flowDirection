<?php /* Smarty version Smarty-3.0.7, created on 2012-03-20 15:28:46
         compiled from "../application/views/blog/member_story_detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5764509614f6831ae6dc934-92192302%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e82e9e0494fd7ef76cf365af77c90a127c1eeaa9' => 
    array (
      0 => '../application/views/blog/member_story_detail.tpl',
      1 => 1332222220,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5764509614f6831ae6dc934-92192302',
  'function' => 
  array (
  ),
...
<div id="content">
	...
	<div class="floatL mg_b">
		...
		<div class="mypaliie_page">
			...
			<div class="middle">
				<div class="container">
					<div class="main_title floatL"><?php echo $_smarty_tpl->getVariable('story')->value['username'];?>
的故事</div>
					<div class="clearboth"></div>
					<div class="content"><!--內文-->
						<!--詳細-->
						<div id="blog_detail">
							<div class="pagelinks"><a href="/index.php/browse_blog/story_list/<?php echo $_smarty_tpl->getVariable('story')->value['userid'];?>
"><?php echo $_smarty_tpl->getVariable('story')->value['username'];?>
的故事</a>><a class="currentPage"><?php echo smarty_modifier_truncate($_smarty_tpl->getVariable('story')->value['albumname'],20);?>
</a></div>
							<div class="bar"><div></div></div>
							<div class="clearboth mg_b"></div>
							<div class="blog_name font_name"><?php echo smarty_modifier_truncate($_smarty_tpl->getVariable('story')->value['albumname'],20);?>
</div>
							<div class="clearboth"></div>
							<div class="floatL font_text1">发布于</div><div class="blog_date font_text1 floatL"><?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('story')->value['dateline'],"%Y/%m/%d");?>
</div>
							<div class="clearboth mg_b"></div>
							<div class="floatL mg_b"><img src="<?php echo $_smarty_tpl->getVariable('story')->value['thumb'];?>
" class="blog_pic img_XL"></div>
							<div class="floatL blog_content">
								<p>
									<?php echo $_smarty_tpl->getVariable('story')->value['description'];?>

								</p>
							<input type="hidden" id="blog_id" value="<?php echo $_smarty_tpl->getVariable('story')->value['albumid'];?>
"></input>
...
"><textarea id="comment_content" ></textarea><div class="btn" onclick="comment(1)" >发表</div>
								</div>
                                <div class="clearboth"></div>
                              <?php }else{ ?>
