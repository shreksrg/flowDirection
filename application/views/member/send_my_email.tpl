			...
			<div class="middle">
				<div class="container">
					...
					<div class="content">
						...
						<!--新增信件-->
                        <form action="{site_url('member/my_email/send_email')}" method="post" enctype="multipart/form-data">
						...
						<div id="newmail">
							...
							<div class="input_container">
								<div class="input">
                                    ...
                                    <input type="checkbox" value="{$v.userid}" name="touserid[]" />{$v.username}&nbsp;&nbsp;
                                    {/foreach}  
								...
								<div class="clearboth"></div>
								<div class="input">
									<div class="newmail_label">主旨：</div><input type="text" id="mail_subject" name="SUBJECT">
								</div>
                                <div class="input">
							...
							<div class="clearboth"></div>
							<textarea id="newmail_content" name="message"></textarea>
							<div class="clearboth"></div>
                        ...
                        <input type="submit" value="保存至草稿箱" name="draft" />
                        </form>
