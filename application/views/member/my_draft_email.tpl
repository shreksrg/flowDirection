			...
			<div class="middle">
				<div class="container">
					...
					<div class="content">
						<!--我的信箱-->
						<div id="mail">
							<div class="title">草稿箱列表</div>
							<div id="newmailBtn" class="add font_text2">草稿箱&nbsp;</div><div id="newmailBtn" class="add font_text2"><a href="/index.php/member/my_email/get_send_email">发件箱</a>&nbsp;</div><div id="newmailBtn" class="add font_text2"><a href="/index.php/member/my_email/index">收件箱&nbsp;</a></div>
