				...
				<div class="container">
					...
					<div class="main_menu">
						<ul>
							...
							<li class="selected" onclick="location.href='/index.php/member/set_habits/index'">生活习性</li>
                    ...
                    <form action="/index.php/member/set_habits/update" method="post" enctype="multipart/form-data">
					<div class="content">
						<ul>
							...
							<li class="life_hobby">
								...
								<div class="label">生活作息:</div>
                                
                                <div class="text"> 
                                
                                <select name="life_habits">
                                    {foreach from=$life item=v key=k}
                                    	<option value="{$k}" {$v.selected}>{$v.life_habits}</option>
                                    {/foreach}  	
                                </select>
                                </div>
                                <div class="clearboth"></div>
                                ...
                                <select name="yd_habits">
                                    {foreach from=$yd item=v key=k}
                                    	<option value="{$k}" {$v.selected}>{$v.yd_habits}</option>
                                    {/foreach}  	
                                </select>
                                </div>
                                <div class="clearboth"></div>
                                ...
                                <select name="smoke">
                                    {foreach from=$smoke item=v key=k}
                                    	<option value="{$k}" {$v.selected}>{$v.smoke}</option>
                                    {/foreach}  	
                                </select>
                                </div>
                                <div class="clearboth"></div>
								...
								<div class="label">喝酒:</div>
                                <div class="text">
                                
                                <select name="drink">
                                    {foreach from=$drink item=v key=k}
                                    	<option value="{$k}" {$v.selected}>{$v.drink}</option>
                                    {/foreach}  	
                                </select>
                                </div>
                                <div class="clearboth"></div>
                                ...
                                <select name="housework">
                                    {foreach from=$housework item=v key=k}
                                    	<option value="{$k}" {$v.selected}>{$v.housework}</option>
                                    {/foreach}  	
                                </select>
                                </div>
                                <div class="clearboth"></div>
								...
								<div class="label">厨艺:</div>
                                <div class="text">
                               
                                <select name="cooking">
                                    {foreach from=$cooking item=v key=k}
                                    	<option value="{$k}" {$v.selected}>{$v.cooking}</option>
                                    {/foreach}  	
                                </select>
                                </div>
                                <div class="clearboth"></div>
								...
								<div class="label">生活技能:</div>
                                <div class="text">
                                {foreach from=$skills item=v key=k}<input type="checkbox" value="{$k}" name="life_skills[]" {$v.checked}/>{$v.life_skills}&nbsp;&nbsp;{/foreach}  
                                </div>	
                                <div class="clearboth"></div>
