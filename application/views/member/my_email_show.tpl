			...
			<div class="middle">
				<div class="container">
					...
					<div class="main_menu floatL">
						<ul>
							<li class="selected" onclick="location.href='/index.php/member/my_email/index'">奇遇信箱<a>(</a><a id="mailcount" class="emNum">{$email_num}</a><a>)</a></li>
					...
					<div class="content">
						...
						<div id="mail_detail">
							...
							<div class="info_container">
								<div class="floatL">
									<a><img src="{$urls}" class="img_M"></a>
								</div>
								<div class="floatL">
                                 <input type="hidden" id="friendId" value="{$member_send_info.userid}" />
			                     <input type="hidden" id="friendName" value="{$member_send_info.username}" />
									<a class="sender">{$send_username}</a>
									<div class="clearboth"></div>
									<div class="sender_info">{$member_send_info.age} {$member_send_info.education} {$member_send_info.regprovince}-{$member_send_info.regcity}</div>
									<div class="clearboth"></div>
									<div class="btns">
							...
							<div class="floatR">
								<div class="floatL mg_l">
									...
									<span id="banmailBtnshow" {if $email_refuse==1}style="display:none"{/if}><a class="banmailBtn" onclick="set_refuse_email('1','{$member_send_info.userid}')"></a></span>
                                    <span id="reportBtnshow" {if $email_refuse==0}style="display:none"{/if}><a class="reportBtn" onclick="set_refuse_email('2','{$member_send_info.userid}')"></a></span>
								</div>
                            ...
                            <form action="/index.php/member/my_email/send_back_email_action" method="post" enctype="multipart/form-data" onsubmit="return check_send_back_email()">
							<div class="quickReply">
								
								<div class="floatL">快速回覆</div>
								<div class="clearboth"></div>
								<div class="floatL mg_r">
									<div class="clearboth"></div>
									<textarea name="message" id="message"></textarea>
									<div class="clearboth mg_b"></div>
									<input type="submit" class="sendmsgBtn floatR" value="">
								</div>
								<div class="floatL">
									<img src="{$urls_2}" class="img_M">
								</div>
							</div>
