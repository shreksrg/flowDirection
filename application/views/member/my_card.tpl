				...
				<div class="container">
					...
					<div class="user_info_container mg_b">
						<div class="info_L floatL mg_r">
							<img src="{$avatar_img}" class="img_XL mg_b" onclick="window.location.href='/index.php/member_info/index/uid/{$card_info.userid}'">
							<div class="clearboth"></div>
					...
					<div class="content_container">
						<div class="menu_container rel">
							<div class="main_menu" >
								<ul>
									<li class="selected normalContact">通訊錄</li>
									<li class="commonContact"><a href="/index.php/member/my_card/often_card_list">常用聯絡人</a></li>
								</ul>
								<div class="end"></div>
							</div>
							<div class="clearboth"></div>
						...
						<div class="card_container">
                            ...
                            {foreach from=$card_list item=v key=k}
								<li>
									...
									<div class="card_R floatR rel">
										...
										<div class="clearboth mg_b"></div>
										<div class="btns abs">
                                        	<div class="add2comContact font_text2 floatL udl"><a href="/index.php/member/my_card/edit_card_info/cardid/{$v.cardid}">编辑</a></div><a class="floatL">｜</a>
											<div class="add2comContact font_text2 floatL udl" onclick="set_often_card('{$v.cardid}')">加入到常用聯絡人</div><a class="floatL">｜</a>
											<div class="del floatL udl" onclick="delete_card('{$v.cardid}')">移除</div>
										</div>
									</div>
								</li>
                              {/foreach}  
