				...
				<div class="container">
					...
					<div class="main_menu">
						<ul>
							...
							<li class="selected"><a href="/index.php/member/set_interests/index">兴趣爱好</a></li>
					...
					<div class="content">
						<ul>
							...
							<li class="habits">
								...
								<!--<div class="edit font_text2"><a href="/index.php/member/set_interests/update">编缉</a></div>-->
								<div class="clearboth"></div>
								<div class="bar"><div></div></div><div class="clearboth"></div>
								<div class="label">喜爱的体育活动:</div><div class="text"><a>{$member_profile.love_yd}</a></div><div class="clearboth"></div>
								<div class="label">喜爱的食物:</div><div class="text"><a>{$member_profile.love_food}</a></div><div class="clearboth"></div>
								<div class="label">喜爱的书籍:</div><div class="text"><a>{$member_profile.love_book}</a></div><div class="clearboth"></div>
								<div class="label">喜爱的影视节目:</div><div class="text"><a>{$member_profile.love_tv}</a></div><div class="clearboth"></div>
								<div class="label">休闲娱乐:</div><div class="text"><a>{$member_profile.leisure}</a></div><div class="clearboth"></div>
								<div class="label">业余爱好:</div><div class="text"><a>{$member_profile.love_hobby}</a></div><div class="clearboth"></div>
								<div class="label">喜爱的旅游地:</div><div class="text"><a>{$member_profile.love_area}</a></div><div class="clearboth"></div>
