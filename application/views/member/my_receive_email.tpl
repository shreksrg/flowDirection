								...
								<div class="display floatR mg_t">
									<div class="sort floatL">
										...
										<div class="sort_container">
											<div class="bg1">
												<div class="sendDate sort_by" onclick="window.location.href='/index.php/member/my_email/index/dateline'">日期</div>
												<div class="mailTitle sort_by" onclick="window.location.href='/index.php/member/my_email/index/SUBJECT'">主旨</div>
												<div class="senderName sort_by" onclick="window.location.href='/index.php/member/my_email/index/fromuserid'">寄件者</div>
											</div>
											<div class="bg2"></div>
										</div>
									</div>
							...
							<div class="list">
                                ...
                                {foreach from=$emailList item=v key=k}
									<li>
										...
										{if $v.isread==0}<div class="mail_status"></div>{else}<div class="mail_status read"></div>{/if}
										<div class="img"><a href="/index.php/member_info/index/uid/{$v.fromuserid}" target="_blank"><img src="{$v.urls}" class="img_S"></a></div>
										<div class="sender">
											<div class="sender_name"><a href="/index.php/member_info/index/uid/{$v.fromuserid}" target="_blank" class="font_title">{$v.send_username}</a></div>
											<div class="clearboth"></div>
										...
										<div class="floatR">
											...
											<div class="clearboth"></div>
											<a href="/index.php/member/my_email/show_email/email_id/{$v.pmid}" class="readmailBtn"></a>
										</div>
										<div class="clearboth"></div> 
									</li>
                                 {/foreach}     
