			...
			<div class="middle">
				<div class="container">
					...
					<div class="content">
						<!--我的信箱-->
						<div>
							<div class="title">已删除信件列表</div>
							<div id="newmailBtn" class="add font_text2">已删除&nbsp;</div><div id="newmailBtn" class="add font_text2"><a href="/index.php/member/my_email/get_garbage_email">垃圾箱</a>&nbsp;</div><div id="newmailBtn" class="add font_text2"><a href="/index.php/member/my_email/get_draft_email">草稿箱&nbsp;</a></div><div id="newmailBtn" class="add font_text2"><a href="/index.php/member/my_email/get_send_email">发件箱</a>&nbsp;</div><div id="newmailBtn" class="add font_text2"><a href="/index.php/member/my_email/index">收件箱&nbsp;</a></div>
							...
							<div class="toolbar">
								<div class="manage floatL">
									...
									<a>全选｜</a>
									<a class="delete" onclick="delete_email('1')">彻底删除</a>
								</div>
							...
							<div class="list">
                                ...
                                {foreach from=$emailList item=v key=k}
									<li>
										...
										<div><a href="/index.php/member/my_email/show_email/email_id/{$v.pmid}">{$v.SUBJECT}</a></div>
										<div class="send_date">{$v['dateline']|date_format:"%Y/%m/%d"}</div>
										<div class="reply font_text2">&nbsp;</div>
										<div class="clearboth"></div> 
									</li>
								{/foreach}  		
