				...
				<div class="container">
					...
					<div class="main_menu">
						<ul>
							...
							<li class="selected"><a href="/index.php/member/set_habits/index">生活习性</a></li>
					...
					<div class="content">
						<ul>
							...
							<li class="life_hobby">
								...
								<div class="edit font_text2"><a href="/index.php/member/set_habits/update">编缉</a></div>
								<div class="clearboth"></div>
								<div class="bar"><div></div></div><div class="clearboth"></div>
								<div class="label">生活作息:</div><div class="text"><a>{$member_profile.life_habits}</a></div><div class="clearboth"></div>
								<div class="label">锻炼习惯:</div><div class="text"><a>{$member_profile.yd_habits}</a></div><div class="clearboth"></div>
								<div class="label">吸烟:</div><div class="text"><a>{$member_profile.smoke}</a></div><div class="clearboth"></div>
								<div class="label">喝酒:</div><div class="text"><a>{$member_profile.drink}</a></div><div class="clearboth"></div>
								<div class="label">家务:</div><div class="text"><a>{$member_profile.housework}</a></div><div class="clearboth"></div>
								<div class="label">厨艺:</div><div class="text"><a>{$member_profile.cooking}</a></div><div class="clearboth"></div>
								<div class="label">生活技能:</div><div class="text"><a>{$member_profile.life_skills}</a></div><div class="clearboth"></div>
