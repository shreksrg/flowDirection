				...
				<div class="container">
					...
					<div class="content"><!--內文-->
						...
						<div id="album_content">
							<div class="back_to_myalbum"><a class="myalbum">個人相冊</a>></div>
							<div class="album_name">{$myAlbumInfo.albumname}</div>
							<div class="addpicbtn" onclick="initFloatTips2()"></div>
							...
							<div id="album_pic_list">
								...
								<div class="clearboth"></div>
								<div class="album_intro">{$myAlbumInfo.description}</div>
							</div>
                            ...
                            <input type="hidden" value="{$myAlbumInfo.albumid}" name="albumid" />
                            </form>
