		...
		<div class="mypaliie_page">
			...
			<div class="middle">
				<div class="container">
					...
					<div class="main_menu">
						<ul>
							<li class="album_user selected"><a href="/index.php/album/index/index">個人相冊</a></li>
					...
					<div class="content"><!--內文-->
						...
						<div id="album_pic_show">
							<div class="back_to_myalbum"><a class="myalbum">個人相冊</a>><a class="current_album_name">{$myAlbumInfo.albumname}</a>></div>
							<div class="current_pic_name">{$myPhotoInfo.title}</div>
							...
							<div class="pic_container">
								...
								<div class="image"><img src="/data/attachment/album/{$myPhotoInfo.filepath}"></div>
								<div class="btn">
									<div class="arrow_right" title="下一張"></div>
								</div>
								<div class="clearboth"></div>
								<div class="pic_name">{$myPhotoInfo.title}
								</div>
								<div class="pic_intro">
									{$myPhotoInfo.description}
								</div>
								<div class="pic_manage">
									<input type="checkbox" id="set_front"><label for="set_front" onclick="set_display('{$myPhotoInfo.picid}','{$myAlbumInfo.albumid}')" style="cursor:pointer;">&nbsp;設為封面</label><a onclick="edit_photo('{$myPhotoInfo.picid}','{$myAlbumInfo.albumid}')">編輯</a><a onclick="delete_my_photo('{$myPhotoInfo.picid}','{$myAlbumInfo.albumid}')">刪除</a>
								</div>
								<div class="clearboth"></div>
                            ...
                            <div class="clearboth"></div>
                            <form action="/index.php/album/index/edit_my_photo_act" method="post"  enctype="multipart/form-data">
                            <div id="photo_edit_window" style="display:none">
                                <div class="window_container">
                                    <div class="window_title_bar">
                                        <div class="window_title">编辑相片</div>
                                        <div class="window_close" onClick="initFloatTipsClose('photo_edit_window')"></div>
                                    </div>
                            ...
                            <input type="hidden"  name="edit_picid"  id="edit_picid"/>
							...
							<div class="pic_list">
                                ...
                                {foreach from=$myPhotoList item=v key=k}
									<li>
										<div class="pic_img"><a href="/index.php/album/index/my_photo_show/albumid/{$myAlbumInfo.albumid}/picid/{$v.picid}"><img src="/data/attachment/album/{$v.filepath}" class="img_M"></a></div>
