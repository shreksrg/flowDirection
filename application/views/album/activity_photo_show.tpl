		...
		<div class="mypaliie_page">
			...
			<div class="middle">
				<div class="container">
					...
					<div class="main_menu">
						<ul>
							<li class="album_user" onclick="location.href='/index.php/album/index/index'">我的照片</li>
					...
					<div class="content"><!--內文-->
						...
						<div id="album_pic_show">
							<div class="back_to_myalbum"><a class="myalbum">活動相冊</a>><a class="current_album_name">{$activityAlbumInfo.albumname}</a>></div>
							<div class="current_pic_name">{$activityPhotoInfo.title}</div>
							...
							<div class="pic_container">
								...
								<div class="image"><img src="/data/attachment/album/{$activityPhotoInfo.filepath}"></div>
								<div class="btn">
									<div class="arrow_right" title="下一張"></div>
								</div>
								<div class="clearboth"></div>
								<div class="pic_name">{$activityPhotoInfo.title}
								</div>
								<div class="pic_intro">
									{$activityPhotoInfo.description}
								</div>
