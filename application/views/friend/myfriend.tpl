			...
			<div class="middle">
				<div class="container">
					...
					<div class="main_menu floatL">
						<ul>
							<li class="myfriend selected" onclick="location.href='/index.php/friend/index'">我的朋友</li>
							<li class="friend_watch"  onclick="location.href='/index.php/friend/index/attention'">我關注的</li>
						...
						<div id="friend">
							...
							<div class="toolbar">
								<div class="manage floatL">
									...
									<a>全选｜</a>
									<a class="delete udl"  onclick="delete_all()">删除</a>
								</div>							
								<div class="sort floatR">
									...
									<div class="sort_container">
										<div class="bg1">
											<div class="name sort_by" onclick="window.location.href='/index.php/friend/index/index/username'" >名字</div>
											<div class="area sort_by" onclick="window.location.href='/index.php/friend/index/index/regcity'" >地區</div>
											<div class="gender sort_by" onclick="window.location.href='/index.php/friend/index/index/gender'" >性別</div>
											<div class="age sort_by" onclick="window.location.href='/index.php/friend/index/index/birthyear'" >年齡</div>
										</div>
										<div class="bg2"></div>
									</div>
								</div>
							...
							<div class="friendlist">
								<ul>
								  {foreach from=$friend_list item=v key=k}
									<li>
										<div class="friend_check floatL"><input type="checkbox" value="{$v['fusuerid']}"></div>
										<div class="friend_img floatL" ><a href="/index.php/member_info/index/uid/{$v['fusuerid']}" target="_blank" ><img src="{$v.avatar_img}" class="img_S"></a></div>
										<div class="friend_info floatL" onclick="window.location.href='/index.php/member_info/index/uid/{$v['fusuerid']}'">
											<a href="/index.php/member_info/index/uid/{$v['fusuerid']}" target="_blank" class="font_title">{if $v['nickname']==''}{$v['fusername']}{else}{$v['nickname']}{/if}</a>
											<div class="clearboth"></div>
