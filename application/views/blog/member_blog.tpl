...
<div id="content">
	...
	<div class="floatL">
		...
		<div class="mypaliie_page">
			...
			<div class="middle">
				<div class="container">
					<div class="main_title floatL">{$member.username}的博文</div>					
					<div class="clearboth"></div>
					<div class="content"><!--內文-->
						<div id="myblog">
							<div class="pagelinks"><a class="currentPage">{$member.username}的博文</a></div>
								...
								<ul>
								   {foreach from=$blogList item=v key=k}
										<li>
											...
											<div class="blog_name" onclick="window.location.href='/index.php/browse_blog/essay_detail/{$v['blogid']}'" ><a>{$v['SUBJECT']|truncate:18:'.'}</a></div>
