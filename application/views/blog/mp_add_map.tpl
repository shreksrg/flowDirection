...
<title>奇遇同城_我的paliie_新增日志</title>
</head>
      ...
      <div class="qy-leaguer-rplateCont">
        <div class="qy-mpcommonTag-headertit"> <b class="qy-mpcommonTag-caption">我的日志</b>
          <ul class="qy-mpcommonTag-switchTags">
            <li class="cursection"><a href="/index.php/blog/map/add">新建日志</a></li>
            <li><a href="/index.php/blog/map">日志管理</a></li>
            
          </ul>
        </div>
        
        <div class="qy-mactive-path">我的日志 > 新建日志</div>
		<form method="post" id="frmLogedit" action="/index.php/blog/map/add" enctype="multipart/form-data">
        <table class="qy-mactive-form" width="0" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td><label id="signArea">{$detail_address}</label>

            <a id="btn-mapSign" class="qy-mapsign-btnsearch" href="/index.php/activity/mapsign/index/0/1">编辑地标</a></td>
