					...
					<div class="content"><!--內文-->
						...
						<div id="addblog">
							...
							<div class="input_container">
								<form action="/index.php/blog/index/edit_essay" method="post">
									<div class="blog_input_label">日誌標題:</div><input type="text" name="subject" value="{$SUBJECT}" class="blog_input_text">
									<div class="clearboth mg_b"></div>
									<div class="blog_input_label">類型:</div>
									<input type="radio" name="blog_type" value="0" class="input_type"  {if $tag=='0'}checked="checked"{/if}>热戀&nbsp;&nbsp;
									<input type="radio" name="blog_type" value="1" class="input_type" {if $tag=='1'}checked="checked"{/if}>牵手&nbsp;&nbsp;
									<input type="radio" name="blog_type" value="2" class="inputg_type"  {if $tag=='2'}checked="checked"{/if}>恋爱&nbsp;&nbsp;
									<div class="clearboth mg_b"></div>
									<div class="blog_input_label blog_content">日誌內容:</div><textarea name="content" class="input_textarea">{$message}</textarea>
									<div class="clearboth mg_b"></div>
