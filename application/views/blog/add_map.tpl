...
<script src="/static/js/display/mypaliie/mymap.js"></script>
		...
		<div class="mypaliie_page">
			...
			<div class="middle">
				<div class="container">
					<div class="content">					
						<!--新增地圖日誌-->
						<form action="/index.php/blog/map/add" method="post" enctype="multipart/form-data"  onsubmit="return checksubmit()">
							<div id="addmap">
								...
								<div class="input_container">
									...
									<div class="map_search">
										...
										<div class="clearboth mg_b"></div>
										<div class="map_input_label">輸入地點名稱:</div><input type="text" id="detail_address" class="map_input_text">
										<button class="positionBtn" onclick="position();return false;"></button>
										<div class="clearboth"></div>
									</div>
									<div class="borderbtm"></div>
									<div class="map_input_label">日誌標題:</div><input type="text" name="subject" class="map_input_text" id="subject">
									<div class="clearboth mg_b"></div>
									<div class="map_input_label">類型:</div>
									<input type="radio" name="blog_type" value="1" class="input_type" checked="checked">旅游&nbsp;&nbsp;
									<input type="radio" name="blog_type" value="2" class="input_type">美食&nbsp;&nbsp;
									<input type="radio" name="blog_type" value="3" class="inputg_type">娱乐&nbsp;&nbsp;
									<div class="clearboth mg_b"></div>
									<div class="map_input_label map_content">日誌內容:</div><textarea name="content" class="input_textarea" id="content_name"></textarea>
									<div class="clearboth mg_b"></div>
									<div class="borderbtm"></div>
									<div class="map_input_label">上傳日誌照片:</div><input name="cover_img" type="file" id="cover_img">
									<div class="clearboth mg_b"></div>
