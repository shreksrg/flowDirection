			...
			<div class="middle">
				<div class="container">
					...
					<div class="main_menu floatL">
						<ul>
							<li id="tab_blog" class="mymap selected" onclick="location.href='/index.php/blog/map/index'">地圖日誌</li>
							<li id="tab_sc" class="mymap_favorite" onclick="location.href='/index.php/blog/map/collection'">我的收藏</li>
						</ul>
						<div class="end"></div>
						<div class="clearboth"></div>
					</div>
					...
					<div class="content">					
						...
						<!--地圖日誌列表-->
						<div id="mymap">
							<div class="title font_text2 mg_b">地圖日誌{$loso}</div>
							...
							<div class="maplist">
								...
								{foreach from=$blogMapList item=v key=k}
									<li>																				
										...
										<div class="map_status">{if $v['STATUS']==1}審核中{else}通過審核{/if}</div>
										<div class="clearboth"></div>
										<div class="manage"><a href="javascript:void(0);" onclick="delete_map_row($(this))" id="{$v['blogid']}">刪除</a>｜<a href="/index.php/blog/map/edit/{$v['blogid']}">編輯</a></div>
										<div class="clearboth"></div>
									</li>
									{/foreach}
								</ul>
