      ...
      <div class="qy-leaguer-rplateCont">
        <div class="qy-mpcommonTag-headertit"> <b class="qy-mpcommonTag-caption">我的活动</b>
          <ul class="qy-mpcommonTag-switchTags">
            <li class="cursection"><a href="/index.php/activity/my_in/index">参加的活动</a></li>
        ...
        <form method="post" id="frmOptions" action="/index.php/activity/my_in/delete_activity_join/">
        ...
        {foreach from=$list item=v key=k}
          <li>
            ...
            <div class="qy-mactive-detail fixwidth">
              ...
              <p class="mactive-counts">活动相册({$v.picnum}) &nbsp;&nbsp; 报名人数({$v.membernum}) <!--&nbsp;&nbsp; 留言(12)--></p>
